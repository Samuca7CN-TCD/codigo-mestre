...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Antes de continuar, você poderia verificar o seu endereço de e-mail clicando no link que acabamos de enviar para
            você? Se você não recebeu o e-mail, ficaremos felizes em enviar outro.
        </div>
