    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Se necessário, você pode encerrar todas as outras sessões do seu navegador em todos os seus dispositivos.
                Algumas das suas sessões recentes estão listadas abaixo; no entanto, essa lista pode não ser exaustiva. Se
                você acha que sua conta foi comprometida, também deve atualizar sua senha.
            </div>
            ...
            <!-- Modal de Confirmação para Encerrar Outros Dispositivos -->
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, insira sua senha para confirmar que você deseja encerrar suas outras sessões de navegador em
